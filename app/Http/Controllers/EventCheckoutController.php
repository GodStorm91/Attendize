...
class EventCheckoutController extends Controller
{
    ...
    public function postValidateTickets(Request $request, $event_id)
    {
        ...
        if (config('attendize.enable_dummy_payment_gateway') == TRUE) {
            ...
            $activeAccountPaymentGateway = !empty($event->account->active_payment_gateway) ? $event->account->active_payment_gateway : false;
            $paymentGateway = !empty($event->account->active_payment_gateway) ? $event->account->active_payment_gateway->payment_gateway : false;
       }
